...
shall do only one __single thing and have a meaninful name__.
{: .panel .tip }
...
operatoin with 5 parameters. We can have multiple of the same.
...
Assigments to temporary variables don't count towards the 1OPS, but
