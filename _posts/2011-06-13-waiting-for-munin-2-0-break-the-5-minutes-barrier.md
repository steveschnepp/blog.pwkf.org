...
tags: munin sysadmin performance
...
**Note:** This protocol is currently completely transparent to `munin-node`, and therefore it means that it can be used even on older (1.x) nodes. Only a 2.0 master is required.
