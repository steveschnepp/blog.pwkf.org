...
One concept gaining huge momentum lately is file versionning (mostly [Git](http://en.wikipedia.org/wiki/Git_(software)) and [Subversion](http://en.wikipedia.org/wiki/Subversion_(software))). It is quite interesting to track the evolution of the data contained in the files, and not only the last time the file was updated.
